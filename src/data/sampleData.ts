...
export const INITIAL_SURVEILLANCE_RECORDS: SurveillanceRecord[] = [
  ...
  },
  {
    ...
    deaths: 22,
    risk: 'Critical',
    comment: 'PPR surge in small ruminants along market routes.',
    sourceFile: '2025_HRVL_Surveillance_Consolidated.xlsx',
    sourceYear: 2025
  },
  {
    id: 'SR-2025-004',
    date: '2025-03-18',
    timestamp: new Date('2025-03-18T14:20:00').getTime(),
    woreda: 'Daro Lebu',
    zone: 'W/H',
    lat: 8.6012,
    lng: 40.3012,
    ...
    deaths: 8,
    risk: 'High',
    comment: 'Dry season herd aggregation CBPP transmission.',
    sourceFile: '2025_HRVL_Surveillance_Consolidated.xlsx',
    sourceYear: 2025
  },
  // 2024 Historical Records
  {
    id: 'SR-2024-001',
    date: '2024-08-10',
    timestamp: new Date('2024-08-10T09:00:00').getTime(),
    woreda: 'Haramaya',
    zone: 'E/H',
    lat: 9.4123,
    lng: 42.0123,
    ...
    deaths: 4,
    risk: 'High',
    comment: '2024 regional FMD baseline surveillance.',
    sourceFile: '2024_HRVL_Annual_Report.xlsx',
    sourceYear: 2024
  },
  {
    id: 'SR-2024-002',
    date: '2024-06-15',
    timestamp: new Date('2024-06-15T13:00:00').getTime(),
    woreda: 'Babile',
    zone: 'E/H',
    lat: 9.2312,
    lng: 42.3321,
    ...
    deaths: 16,
    risk: 'High',
    comment: 'Transboundary border grazing movement PPR cases.',
    sourceFile: '2024_HRVL_Annual_Report.xlsx',
    sourceYear: 2024
  },
  {
    id: 'SR-2024-003',
    date: '2024-04-22',
    timestamp: new Date('2024-04-22T10:15:00').getTime(),
    woreda: 'Habro',
    zone: 'W/H',
    lat: 8.8212,
    lng: 40.5312,
    ...
    deaths: 12,
    risk: 'Critical',
    comment: 'Soil disturbance post-first rains anthrax outbreak.',
    sourceFile: '2024_HRVL_Annual_Report.xlsx',
    sourceYear: 2024
  },
  // 2023 Historical Records
  {
    id: 'SR-2023-001',
    date: '2023-09-02',
    timestamp: new Date('2023-09-02T11:00:00').getTime(),
    woreda: 'Haramaya',
    zone: 'E/H',
    lat: 9.4123,
    lng: 42.0123,
    ...
    deaths: 2,
    risk: 'Medium',
    comment: '2023 baseline FMD surveillance record.',
    sourceFile: '2023_Archive_Surveillance.xlsx',
    sourceYear: 2023
  },
  {
    id: 'SR-2023-002',
    date: '2023-07-19',
    timestamp: new Date('2023-07-19T15:30:00').getTime(),
    woreda: 'Chiro',
    zone: 'W/H',
    lat: 9.0812,
    lng: 40.8712,
    ...
    deaths: 2,
    risk: 'Medium',
    comment: '2023 LSD outbreak in lower valley kebeles.',
    sourceFile: '2023_Archive_Surveillance.xlsx',
    sourceYear: 2023
  },
  {
    id: 'SR-2023-003',
    date: '2023-10-12',
    timestamp: new Date('2023-10-12T08:45:00').getTime(),
    woreda: 'Girawa',
    zone: 'E/H',
    lat: 9.1342,
    lng: 41.8312,
    ...
    deaths: 75,
    risk: 'High',
    comment: '2023 Newcastle disease endemic surge.',
    sourceFile: '2023_Archive_Surveillance.xlsx',
    sourceYear: 2023
  }
];
