...
// DiseaseSummaryTable
processFile('src/components/DiseaseSummaryTable.tsx', 's.disease', /\{s\.disease\}/);

// OutbreakTable
processFile('src/components/OutbreakTable.tsx', 'ob.disease', /\{ob\.disease\}/);

// SurveillanceTable
processFile('src/components/SurveillanceTable.tsx', 'rec.disease', /\{rec\.disease\}/);
